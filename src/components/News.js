...
//     return (
//       <>
//         <h2 className="text-center" style={{margin: "35px 0px", marginTop:'90px'}}> DailyDose - Top  {this.props.category.charAt(0).toUpperCase() + this.props.category.slice(1)} Headlines</h2>
...
// export default News
    ...
    return (
        <>
            <h2 className="text-center" style={{margin: "35px 0px", marginTop:'90px'}}> DailyDose - Top  {props.category.charAt(0).toUpperCase() + props.category.slice(1)} Headlines</h2>
            {loading && <Spinner/>}
